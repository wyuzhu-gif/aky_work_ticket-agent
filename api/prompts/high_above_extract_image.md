...
**所有条都要写**, 一条不漏 (即使 OCR 完全没识别到, 也用 GB 原文写)
OCR 文本中**额外**有清单之外的安全措施 → 也写入

## 安全措施参考清单 (GB 30871-2022 高处作业, **逐条匹配**)

- 作业人员身体条件符合高处作业要求，无高处作业禁忌症（如高血压、心脏病等）
- 作业人员已按规定穿戴工作服、防滑鞋、安全帽等个体防护装备
- 作业人员佩戴安全带（绳）等防坠落装置
- 工具袋已配备到位，作业人员禁止随手抛掷工具
- 脚手架、跳板、梯子等作业平台已搭设牢固，并经验收合格
- 作业平台、通道、临边、洞口等中间隔离防护设施已设置到位
- 梯子、绳索等登高用具的强度、规格符合要求，连接牢固
- 轻型棚、检修架等临时设施的结构稳固
- 吊装作业、承重板铺设等已按要求设置
- 采光、夜间作业照明设施已配备到位
- 30m 以上高处作业已配备通信联络工具
- 警戒区、警示标志、警示灯已按要求设置
- 露天作业时环境风力满足作业安全要求（6 级及以上大风停止作业）
- 其他相关特殊作业已办理相应安全作业票
- 其他安全措施
