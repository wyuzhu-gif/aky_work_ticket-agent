...
CREATE TABLE IF NOT EXISTS rule_documents (
    ...
    source_type TEXT NOT NULL DEFAULT 'context',
    extracted_text TEXT,
    parsed_rule_ids TEXT,
    status TEXT NOT NULL DEFAULT 'active',
    created_at TEXT NOT NULL,
    updated_at TEXT
);
...
CREATE_DOCUMENT_RULE_DOCUMENTS_TABLE = """
CREATE TABLE IF NOT EXISTS document_rule_documents (
    doc_id TEXT NOT NULL,
    rule_document_id TEXT NOT NULL,
    enabled INTEGER NOT NULL DEFAULT 1,
    PRIMARY KEY (doc_id, rule_document_id)
);
"""
