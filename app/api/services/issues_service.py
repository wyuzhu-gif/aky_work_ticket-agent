...
from common.models import Issue, IssueStatusEnum, ModifiedFieldsModel, DismissalFeedbackModel, ReviewRule, RuleDocument
...
class IssuesService:
    ...
    async def initiate_review(
        ...
        try:
            ...
            stream_data = self.pipeline.stream_issues(pdf_path, user.oid, timestamp_iso, custom_rules, rule_documents)
